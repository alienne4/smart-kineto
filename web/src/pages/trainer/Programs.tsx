...
import { Badge, Empty, IconTile, Spinner, useApi } from "../../components/ui";
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <Empty icon="programs" title={tab === "MINE" ? "No programs yet" : "Library is empty"} subtitle={tab === "MINE" ? "Build a program from your exercises." : "Predefined programs will appear here."} />
      ) : (
