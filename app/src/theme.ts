...
export const type: Record<string, TextStyle> = {
  display: { fontSize: 30, fontWeight: "800", color: colors.text },
...
export const BODY_PART_META: Record<string, { label: string; icon: keyof typeof import("@expo/vector-icons").Ionicons.glyphMap; grad: readonly [string, string] }> = {
