# Generated by Django 5.1.4 on 2026-06-17 06:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('TRAINER', 'Trainer'), ('PATIENT', 'Patient')], default='PATIENT', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_trainer', models.ForeignKey(blank=True, limit_choices_to={'role': 'TRAINER'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patients', to=settings.AUTH_USER_MODEL)),
